    ...
    opportunityService.getById(id)
      .then(res => {
        ...
        setForm({
          ...
          volunteerHours: opp.volunteerHours || 0,
          mode: opp.mode || '',
          city: opp.city || '',
          location: opp.location || '',
          category: opp.category || '',
          roleTitle: opp.roleTitle || '',
          seatsAvailable: opp.seatsAvailable || 5,
      ...
      <div className="max-w-3xl mx-auto py-8 animate-fade-in">
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-0.5 text-sm">Update your opportunity details below.</p>
          </div>
        </div>
